...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton_5.setProperty("lineup", QCoreApplication.translate("Form", u"lineup5", None))
        ...
        self.radioButton_4.setProperty("lineup", QCoreApplication.translate("Form", u"lineup4", None))
        ...
        self.radioButton_2.setProperty("lineup", QCoreApplication.translate("Form", u"lineup2", None))
        ...
        self.pushButton_2.setText(QCoreApplication.translate("Form", u"F2 - \u81ea\u52a8\u62ff\u5361\uff1a\u5173", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"F3 - \u81ea\u52a8\u5b58\u5361\uff1a\u5173", None))
        self.radioButton.setText(QCoreApplication.translate("Form", u"\u9635\u5bb91", None))
        self.radioButton.setProperty("lineup", QCoreApplication.translate("Form", u"lineup1", None))
        ...
        self.radioButton_3.setProperty("lineup", QCoreApplication.translate("Form", u"lineup3", None))
